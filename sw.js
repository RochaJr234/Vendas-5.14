const CACHE="controle-vendas-5.14.2";
const ASSETS=["./","./index.html","./style.css","./script.js","./manifest.webmanifest","./assets/rocha-digital-splash.png","./assets/rocha-digital-splash.jpg","./assets/rocha-digital-abertura.jpg","./assets/rocha-digital-logo.jpg","./icon-192.png","./icon-512.png"];
